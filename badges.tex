  ...
  \begin{tikzpicture}
    ...
    % size that fits.
      ...
      \node [anchor=mid] at (\BadgeWidth / 2, \BadgeHeight / 2)
        {\textbf{\fontsize{22}{22}\selectfont{\name}}};
  

    \node [anchor=base] at (\BadgeWidth / 2, 1.8) {\Large{\mpg}};

    %% The bottom line
    \ifthenelse{\equal{\mpg}{}}{}{\attendsEventA}
    \ifthenelse{\equal{\mpg}{}}{}{\attendsEventB}
    \ifthenelse{\equal{\mpg}{}}{}{\attendsEventC}
    \ifthenelse{\equal{\mpg}{}}{}{\attendsEventD}
