...
\usepackage{anyfontsize,csvsimple,xifthen,tikz,xcolor,xstring}
\usetikzlibrary{calc}
...
\newcommand*{\SingleBadge}[1]{
  ...
  \begin{tikzpicture}
    ...
    \ifthenelse{\cnttest{\StrLen{\mpg}}{>}{0}}{\colorlet{StripeColor}{mpg}}{}
    \ifthenelse{\equal{\hgf}{}}{}{\colorlet{StripeColor}{hgf}}
